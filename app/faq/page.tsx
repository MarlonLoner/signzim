...
export const metadata: Metadata = {
  title: "Sign Zim FAQ | Signage Quotes and Provider Listings",
  description:
    "Answers for Zimbabwean customers requesting signage quotes and signage companies listing on Sign Zim."
};
    ...
    <div className="page-shell py-12">
      <div className="max-w-4xl">
        ...
        <p className="mt-5 text-lg leading-8 text-zinc-300">
          Clear answers for customers looking for signage in Zimbabwe and providers preparing to join the marketplace.
        </p>
      </div>

      <div className="mt-10 grid gap-6 lg:grid-cols-2">
        <FaqSection eyebrow="For customers" title="Requesting signage quotes" items={customerFaqs} />
        <FaqSection eyebrow="For signage companies" title="Listing your provider profile" items={providerFaqs} />
      </div>
      ...
      <div className="mt-10 grid gap-4 rounded-lg border border-amberglow/30 bg-amberglow/10 p-6 md:grid-cols-[1fr_auto_auto] md:items-center">
        <div>
          ...
          <p className="mt-2 text-sm text-zinc-300">Send one request or submit your signage company for review.</p>
        </div>
